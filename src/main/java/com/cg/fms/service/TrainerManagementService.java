...
public class TrainerManagementService implements ITrainerManagement {
	...
	@Override
	public EmployeeModel updateEmployee(long employee_id, EmployeeModel empmodel) throws Exception {
		if (empmodel!= null) {
			if (!employeeRepo.existsById(employee_id)) {
				throw new Exception("No Such Employee");
			}

			empmodel = parser.parse(employeeRepo.save(parser.parse(empmodel)));
		}
